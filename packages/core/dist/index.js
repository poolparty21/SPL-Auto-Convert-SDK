...
import { PublicKey, LAMPORTS_PER_SOL, Keypair, Connection } from '@solana/web3.js';
...
function deriveKey(password, serverSecret, salt) {
  return crypto.pbkdf2Sync(password + serverSecret, salt, 1e5, KEY_LENGTH, "sha512");
}
function deriveServerKey(serverSecret, salt) {
  return crypto.pbkdf2Sync(serverSecret, salt, 1e5, KEY_LENGTH, "sha512");
}
